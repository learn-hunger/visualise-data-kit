...
export const C_DETECTORS_DATA: Record<TDetectors, NCanvas.IDetectorsData> = {
...
export const C_CUSTOM_DEFAULT_STYLE: NCanvas.IStyle = { line: { color: '#0000FF', width: 2, }, point: { color: '#0000FF', width: 2 } };
