...
self.onmessage = function (e) {
    ...
    // Handle drawing data
    const { dataPoints, metricX, metricY, landmarksStyle, connections, labelStyle,showLabels } = e.data;
    const data = { dataPoints, metricX, metricY, landmarksStyle, connections, labelStyle };

    // Draw using the shared function
    drawLandmarks(canvasContext, data, canvasContext.canvas.width, canvasContext.canvas.height,showLabels);
};
